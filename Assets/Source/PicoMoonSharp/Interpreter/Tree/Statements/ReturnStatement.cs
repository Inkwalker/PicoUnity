...
namespace PicoMoonSharp.Interpreter.Tree.Statements
{
	class ReturnStatement: Statement
	{
		...
		public ReturnStatement(ScriptLoadingContext lcontext, bool oneLine = false)
			: base(lcontext)
		{
			...
			if (cur.IsEndOfBlock() || cur.Type == TokenType.SemiColon || (oneLine && ret.FromLine != cur.FromLine))
			{
				m_Expression = null;
