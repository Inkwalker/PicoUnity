...
using PicoMoonSharp.Interpreter.Tree.Statements;
...
namespace PicoMoonSharp.Interpreter.Tree
{
	abstract class Statement : NodeBase
	{
		...
		protected static Statement CreateStatement(ScriptLoadingContext lcontext, out bool forceLast, bool oneLine = false)
		{
			...
			switch (tkn.Type)
			{
				...
				case TokenType.Return:
					forceLast = true;
					return new ReturnStatement(lcontext, oneLine);
