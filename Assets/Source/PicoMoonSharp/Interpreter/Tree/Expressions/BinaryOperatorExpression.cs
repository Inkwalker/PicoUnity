...
namespace PicoMoonSharp.Interpreter.Tree.Expressions
{
	/// <summary>
	/// 
	/// </summary>
	class BinaryOperatorExpression : Expression
	{
        ...
        public static Expression CreateAddEpression(Expression op1, Expression op2, ScriptLoadingContext lcontext)
        {
            return new BinaryOperatorExpression(op1, op2, Operator.Add, lcontext);
        }

        public static Expression CreateSubEpression(Expression op1, Expression op2, ScriptLoadingContext lcontext)
        {
            return new BinaryOperatorExpression(op1, op2, Operator.Sub, lcontext);
        }

        public static Expression CreateDivEpression(Expression op1, Expression op2, ScriptLoadingContext lcontext)
        {
            return new BinaryOperatorExpression(op1, op2, Operator.Div, lcontext);
        }

        public static Expression CreateMulEpression(Expression op1, Expression op2, ScriptLoadingContext lcontext)
        {
            return new BinaryOperatorExpression(op1, op2, Operator.Mul, lcontext);
        }

        public static Expression CreateModEpression(Expression op1, Expression op2, ScriptLoadingContext lcontext)
        {
            return new BinaryOperatorExpression(op1, op2, Operator.Mod, lcontext);
        }
