...
namespace PicoMoonSharp.Interpreter
{
	...
	public class Script : IScriptPrivateResource
	{
		...
		public DynValue LoadString(string code, Table globalTable = null, string codeFriendlyName = null)
		{
            ...
            const string BASE64_DUMP_HEADER = "MoonSharp_dump_b64::";

            if (code.StartsWith(BASE64_DUMP_HEADER))
			{
				code = code.Substring(BASE64_DUMP_HEADER.Length);
