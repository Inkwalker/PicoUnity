...
using PicoMoonSharp.Interpreter.Interop.Converters;

namespace PicoMoonSharp.Interpreter.Interop
{
	/// <summary>
		...
		IWireableDescriptor
	{
		...
		public void SetValue(Script script, object obj, DynValue v)
		{
			...
			{
				if (value is Fix)
					value = NumericConversions.FixToType(PropertyInfo.PropertyType, (Fix)value);
