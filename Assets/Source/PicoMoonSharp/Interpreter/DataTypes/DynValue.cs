...
namespace PicoMoonSharp.Interpreter
{
	...
	public sealed class DynValue
	{
		...
		/// </summary>
		public Fix Number { get { return m_Number; } }
		/// <summary>
		...
		/// </summary>
		public static DynValue NewNumber(Fix num)
		{
			return new DynValue()
			{
				m_Number = num,
		...
		public override int GetHashCode()
		{
			...
			switch (Type)
			{
				...
				case DataType.Boolean:
					...
					break;
				case DataType.Number:
					m_HashCode = baseValue ^ (int)(Number).GetHashCode();
					break;
				case DataType.String:
		...
		public Fix? CastToNumber()
		{
			...
			else if (rv.Type == DataType.String)
			{
				...
				if (double.TryParse(rv.String, NumberStyles.Any, CultureInfo.InvariantCulture, out num))
					return (Fix)num; //TODO: support for hex and binary numbers
 			}
			return null;
		}
		...
		/// </summary>
		internal void AssignNumber(Fix num)
		{
			if (this.ReadOnly)
		...
		{
			return PicoMoonSharp.Interpreter.Interop.Converters.ClrToScriptConversions.ObjectToDynValue(script, obj);
		}
		...
		{
			return PicoMoonSharp.Interpreter.Interop.Converters.ScriptToClrConversions.DynValueToObject(this);
		}
		...
		public object ToObject(Type desiredType)
		{
			...
			return PicoMoonSharp.Interpreter.Interop.Converters.ScriptToClrConversions.DynValueToObjectOfType(this, desiredType, null, false);
		}
